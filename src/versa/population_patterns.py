...
demand via `versa aggregate-patterns` (cli.py), the same "explicit,
no automatic per-turn trigger" precedent as `versa consolidate-session`.
...
from versa.vector_math import cosine_similarity, running_mean
