-- versa: interactions — append-only per-turn interaction log for the
-- personalization/retrieval subsystem (see src/versa/interactions.py,
-- src/versa/retrieval.py).
--
...
-- 030, memory.py) and the "story" view keep their
